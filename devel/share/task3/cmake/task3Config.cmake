...
if("TRUE" STREQUAL "TRUE")
  set(task3_SOURCE_PREFIX /home/vboxuser/Desktop/ros_ws/src/task3)
  set(task3_DEVEL_PREFIX /home/vboxuser/Desktop/ros_ws/devel)
  set(task3_INSTALL_PREFIX "")
  set(task3_PREFIX ${task3_DEVEL_PREFIX})
else()
  set(task3_SOURCE_PREFIX "")
  set(task3_DEVEL_PREFIX "")
  set(task3_INSTALL_PREFIX /home/vboxuser/Desktop/ros_ws/install)
...
if(NOT "/home/vboxuser/Desktop/ros_ws/src/task3/include " STREQUAL " ")
  set(task3_INCLUDE_DIRS "")
  set(_include_dirs "/home/vboxuser/Desktop/ros_ws/src/task3/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'firejeson <firejeson@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'task3' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vboxuser/Desktop/ros_ws/src/task3/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/vboxuser/Desktop/ros_ws/devel/lib;/home/vboxuser/Desktop/ros_ws/devel/lib;/opt/ros/noetic/lib)
